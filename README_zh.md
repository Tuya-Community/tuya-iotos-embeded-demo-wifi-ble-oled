# Tuya IoTOS Embeded Demo WiFi & BLE Oled screen
...
本 Demo 基于涂鸦智能云平台、涂鸦智能APP、IoTOS Embeded WiFi &Ble SDK，使用涂鸦WiFi/WiFi+BLE系列模组快速组建一个Oled屏幕demo，可以将温湿度传感器的数值显示到屏幕上。
## 快速上手
...
├── src	
|    ├── app_driver
|    |    ├── sh1106.c            //oled屏幕相关驱动接口
|    |    └── sht21.c             //sht21温湿度传感器驱动接口
|    ├── app_soc                   //tuya SDK soc层接口相关文件
|    ├── tuya_device.c             //应用层入口文件
|    ├── app_oled.c                //主要应用层
|    └── app_control.c            //数据采集和显示逻辑相关
|
├── include				//头文件目录
|    ├── app_driver
|    |    ├── sh1106.h           
